...
- **Category**: _[data / timing / concurrency / partial state / permissions / boundary]_
...
**Concurrency**: What if two users edit the same record? What if the same user has two tabs open? What if a background job processes data that a user is currently editing?
